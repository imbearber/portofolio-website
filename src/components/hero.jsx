            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div className="flex flex-col gap-5">
                    ...
                    <div className="flex items-center gap-3 mt-6">
                        <div className="flex -space-x-3">
                            <img src="/client1.png" alt="Client 1" className="w-10 h-10 rounded-full border-2 border-bg-main object-cover bg-gray-300" />
                            <img src="/client2.png" alt="Client 2" className="w-10 h-10 rounded-full border-2 border-bg-main object-cover bg-gray-400" />
                            <img src="/client3.png" alt="Client 3" className="w-10 h-10 rounded-full border-2 border-bg-main object-cover bg-gray-500" />
                        </div>
                ...
                <div className="relative flex justify-center items-center mt-10 md:mt-0">
                    <div className="w-[300px] h-[300px] md:w-[400px] md:h-[400px] rounded-full overflow-hidden bg-gray-200 relative z-10 shadow-2xl">
                        <img src="src/assets/photo-profile.png" alt="Berliano Profil" className="w-full h-full object-cover" />
                    </div>
                    ...
                    <div className="absolute top-10 right-5 md:-right-8 z-0 animate-melayang [animation-delay:0.5s]">
                        <img src="src/assets/figma-logo.svg" alt="figma logo" className="w-20 h-20"/> 
                    </div>

                    <div className="absolute bottom-10 left-5 md:-left-5 z-20 animate-melayang [animation-delay:2s]">
                        <img src="src/assets/sketch-logo.svg" alt="sketch logo" className="w-20 h-20"/> 
                    </div> 
                </div>
